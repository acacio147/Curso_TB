 ...
 */
  ...
  Router::connect('paginas/como-chegar',  array('controller' => 'pages', 'action' => 'display', 'como-chegar'));
  Router::connect('/como-chegar',         array('controller' => 'pages', 'action' => 'display', 'como-chegar'));
  Router::connect('paginas/home',         array('controller' => 'pages', 'action' => 'display', 'home'));
  Router::connect('/paginas',             array('controller' => 'pages', 'action' => 'display', 'home'));
